...
Der Kampfrichter kann auch keinem der Fechter den Punkt geben wegen Gleichzeitigkeit (Simultane). 
...
Dafür gibt es die weißen Lampen. Immer wenn zwei Lampen leuchten (egal ob weiß, grün oder rot) entscheidet der Kampfrichter nach Angriffsrecht wer den Punkt bekommt.
...
* C nein, nur im Florett

B Nein.

Im Prinzip bekommt in jeder der drei Waffen der Fechter erst den Punkt wenn der Kampfrichter es so entscheidet. Erst wenn der Kampf wieder aufgenommen wurde ist der Punkt fest vergeben. Beispiel: Waffe funktioniert nicht oder Videobeweis. 
